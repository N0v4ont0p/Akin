...
const TIMELINE: TimelineNode[] = [
  {
    ...
    icon: "🌑",
    color: "#89f7fe",
    reveals: "Identity sealed. Mystery begins.",
    hint: "Who picked you?",
    tierKey: "echo",
  },
  {
    ...
    icon: "🌒",
    color: "#00e5a0",
    reveals: "Their comfort food revealed",
    hint: "A taste of who they are",
    tierKey: "recognition",
  },
  {
    hour: 32,
    ...
    icon: "🌓",
    color: "#fee140",
    reveals: "Major & campus vibe revealed",
    hint: "Getting warmer...",
  ...
  },
  {
    ...
    icon: "✦",
    color: "#9b6dff",
    reveals: "Photo shatters. Name & deep fact unlocked.",
    hint: "The full picture",
    tierKey: "bond",
  },
];
